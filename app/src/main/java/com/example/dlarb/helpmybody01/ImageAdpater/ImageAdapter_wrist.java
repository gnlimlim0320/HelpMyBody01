...
public class ImageAdapter_wrist extends ArrayAdapter<String> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        final Integer[] images = {R.drawable._wrist1, R.drawable._wrist2,R.drawable._wrist3,R.drawable._wrist4,R.drawable._wrist5,R.drawable._wrist6,R.drawable._wrist7};
