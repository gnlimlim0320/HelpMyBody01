...
import com.example.dlarb.helpmybody01.bodypart.Waist_Youtube.WaistYoutube8;
...
public class Waist extends AppCompatActivity {
    ...
    protected void onCreate(Bundle bundle){
        ...
        "[고투더헬th] 틀어진 골반, 요추 통증, 디스크 잡는 골반 셀프 교정법///(골반교정 스트레칭)","허리 아플때 좋은 운동 / 자세 꿀팁과 경고!!(일상,스트레칭,운동,순서)," ,
                "허리,척추건강에 좋은운동! [척추기립근을 강화하고 척추측만증운동에 굿!]"};
        ...
        listView.setOnItemClickListener(
                new AdapterView.OnItemClickListener() {
                    Class[] Waist_Youtube = new Class[]{WaistYoutube1.class, WaistYoutube2.class,WaistYoutube3.class,WaistYoutube4.class,WaistYoutube5.class,WaistYoutube6.class,WaistYoutube7.class, WaistYoutube8.class};
